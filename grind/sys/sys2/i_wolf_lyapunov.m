function [Texp,Lexp]=i_wolf_lyapunov(n,rhs_ext_fcn,fcn_integrator,tstart,stept,tend,ystart,ioutp)
%
...
% Solutuion of extended ODE system 
  ...
  [~,Y] = feval(fcn_integrator,rhs_ext_fcn,[t t+stept/2 t+stept],y);  
