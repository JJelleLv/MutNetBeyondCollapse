function vars = i_symvar(s, filter)
...
%%%%%%%%%%%%%%%START OF CHANGES%%%%%%%%%%%%%%%%%%%%%
% we need to modify the filter as i and j can be parameters
% further I remove comments and function handles (_name is neglected as it
% is not allowed in MATLAB)
% EvN
%
i = strfind(char(s), '%'); %strip off comments
if ~isempty(i)
   s = s(1:i(1));
end

s=strrep(s,'@','_'); %removes function handles
